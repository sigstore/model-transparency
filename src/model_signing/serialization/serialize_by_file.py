...
class DigestSerializer(FilesSerializer):
    ...
    this will likely change in a subsequent change.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            file_hasher_factory: A callable to build the hash engine used to hash
              individual files. Because each file is processed in parallel, every
              thread needs to call the factory to start hashing.
