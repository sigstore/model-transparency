...
class TestSerializer:
    ...
    def test_max_workers_does_not_change_digest(self, sample_model_folder):
        serializer1 = file.Serializer(self._hasher_factory)
        serializer2 = file.Serializer(self._hasher_factory, max_workers=1)
        serializer3 = file.Serializer(self._hasher_factory, max_workers=3)
